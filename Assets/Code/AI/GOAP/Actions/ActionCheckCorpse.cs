...
public class ActionCheckCorpse: GoapAction 
{
	...
	public void UpdateAction()
	{
		...
		if(ParentCharacter.MyAI.BlackBoard.TargetCorpse != null)
		{
			...
			{
				if(((Character)ParentCharacter.MyAI.BlackBoard.TargetCorpse.Target).Faction == ParentCharacter.Faction)
				{
					//if corpse and I are in same faction, then I'll check corpse and then raise alert
					if(ParentCharacter.MyNavAgent.velocity.magnitude <= 0.1f)
					{
